...
def predict_chances(request):
    ...
    if request.POST.get('action') == 'post':
        ...
        aqi_data_updated = pd.read_csv(r'C:\Users\hp\PycharmProjects\djangoProject\iris\AQI_Data_Updated.csv')
        ...
        result = val
        model = pd.read_pickle(r'C:\Users\hp\PycharmProjects\djangoProject\iris\new_model_realtime.pickle')
